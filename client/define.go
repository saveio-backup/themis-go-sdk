...
type ChainClient interface {
	...
	getSmartContractEventByEventIdAndHeights(qid string, contractAddress string, address string, eventId, startHeight, endHeight uint32) ([]byte, error)
...
const (
	...
	RPC_GET_SMART_CONTRACT_EVENT_BY_EVENT_ID_HEIGHTS = "getsmartcodeeventbyeventidandheights"
...
const (
	...
	GET_SMTCOCE_EVT_ID_HEIGHTS = "/api/v1/smartcode/event/heights/"
...
const (
	...
	WS_ACTION_GET_SMARTCONTRACT_BY_EVENT_ID_HEIGHTS = "getsmartcodeeventbyeventidandheights"
